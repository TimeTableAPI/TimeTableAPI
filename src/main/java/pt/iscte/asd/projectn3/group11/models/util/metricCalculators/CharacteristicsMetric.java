...
public class CharacteristicsMetric implements MetricCalculator{

	/**
	 * <p>Metric to evaluate the quality of the assigned Classrooms compared to the characteristics the class needed.</p>
	 *
	 * @return a float between 0 and 1 representing the percentage of characteristics that were fullfilled.
	 * */
	@Override
